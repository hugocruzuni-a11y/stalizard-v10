...
if not run:
    ...
    # MERCADOS 0.5 REMOVIDOS
    mkts = [
        ("WIN: "+h_n, ph, m1), ("WIN: "+a_n, pa, m2), ("DRAW (X)", px, mx),
        ("O1.5 GOALS", np.mean(stot>1.5), o15_i), ("O2.5 GOALS", np.mean(stot>2.5), o25_i), ("O3.5 GOALS", np.mean(stot>3.5), o35_i),
        ("U1.5 GOALS", np.mean(stot<1.5), u15_i), ("U2.5 GOALS", np.mean(stot<2.5), u25_i), ("U3.5 GOALS", np.mean(stot<3.5), u35_i),
